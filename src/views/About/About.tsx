...
import { MENU, SKILLS } from '@/constants';
  ...
  return (
    <Container id={MENU.ABOUT} className='mb-80 md:mb-20 pt-24'>
      ...
      <div
        ...
        {!(isSafari && isMobile) && (
          <div className='absolute md:right-0 z-0 mt-5 mr-10 md:-mt-10 md:mr-0 md:ml-5 md:mb-10 w-48 h-64 border-2 border-white rounded' />
        )}
      </div>
    </Container>
  );
